...
<div class="col-md-12">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-center">Edit Dokumentasi</h5>
                <form action="{{ route('dashboard.dokumentasi.update', $dokumentasi->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
