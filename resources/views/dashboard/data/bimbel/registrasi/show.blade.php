                                ...
                                <h5 class="card-title text-center"><strong>Data Pendaftar</strong></h5>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control" name="nama_anak" value="{{ $bimbel->nama_anak }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="number" class="form-control" name="usia" value="{{ $bimbel->usia }}" placeholder="Masukan Umur Dengan Angka">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Kelas Berjalan <code>*</code></label>
                                            <input readonly type="text" class="form-control" name="kelas_berjalan" value="{{ $bimbel->kelas_berjalan }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <div class="form-group">
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Senin" value="Senin" @if(in_array('Senin', $jadwal_hari)) {{ 'checked' }} @endif>
                                            <label class="form-check-label" for="Senin">Senin</label>
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Selasa" value="Selasa" @if(in_array('Selasa', $jadwal_hari)) {{ 'checked' }} @endif>
                                            <label class="form-check-label" for="Selasa">Selasa</label>
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Rabu" value="Rabu" @if(in_array('Rabu', $jadwal_hari)) {{ 'checked' }} @endif>
                                            <label class="form-check-label" for="Rabu">Rabu</label>
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Kamis" value="Kamis" @if(in_array('Kamis', $jadwal_hari)) {{ 'checked' }} @endif>
                                            <label class="form-check-label" for="Kamis">Kamis</label>
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Jum'at" value="Jum'at" @if(in_array("Jum'at", $jadwal_hari)) {{ 'checked' }} @endif>
                                            <label class="form-check-label" for="Jum'at">Jum'at</label>
                                            <input class="form-check-input" type="checkbox" disabled name="jadwal_hari[]" id="Sabtu" value="Sabtu" @if(in_array('Sabtu', $jadwal_hari)) {{ 'checked' }} @endif>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="date" class="form-control" name="tanggal_mulai" value="{{ $bimbel->tanggal_mulai }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Jam Les Privat <code>*</code></label>
                                            <input readonly type="time" class="form-control" name="jam_les" value="{{ $bimbel->jam_les }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Pelajaran Tertentu</label>
                                            <input readonly type="text" class="form-control" name="pelajaran_tertentu" value="{{ $bimbel->pelajaran_tertentu }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Iqro/Al qur'an Jus Berapa Saat ini? <code>*</code></label>
                                            <input readonly type="text" class="form-control" name="mengaji" value="{{ $bimbel->mengaji }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control" name="asal_sekolah" value="{{ $bimbel->asal_sekolah }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Agama <code>*</code></label>
                                            <input readonly type="text" class="form-control" name="agama" value="{{ $bimbel->agama }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            <label for="">Nama Orang Tua <code>*</code></label>
                                            <input readonly type="text" class="form-control" name="orang_tua" value="{{ $bimbel->orang_tua }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control mt-2" name="catatan_anak_didik" value="{{ $bimbel->catatan_anak_didik }}" placeholder="Catatan Anak Didik">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group">
