...
<div class="col-md-12">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-center">Edit Deskripsi</h5>
                <form action="{{ route('dashboard.deskripsi.anak.update', $deskripsi->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <input type="number" class="form-control" name="sesi" value="{{ old('sesi', $deskripsi->sesi) }}">
                        </div>
                        <div class="col-md-12 mt-2">
                            <label for="">Deskripsi Perkembangan Anak</label>
                            <textarea name="description" class="form-control" id="" cols="30" rows="10">{{ $deskripsi->description }}</textarea>
                        </div>
                    </div>
