    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div>
            <a href="{{ route('register.bimbel') }}" class="btn-get-started"><i class="bi bi-book"></i> Daftar Bimbel</a>
            <a href="{{ route('register.guru') }}" class="btn-get-started" style="background: rgb(245, 245, 41); color: black;"><i class="bi bi-user" style="-color: black;"></i> Daftar Guru</a>
        </div>
        </div>
