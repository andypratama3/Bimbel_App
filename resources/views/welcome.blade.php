    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img">
                <img src="{{ asset('assets_dashboard/img/hero-img.png') }}" class="img-fluid" alt="">
            </div>
        </div>
    </div>
...
<section id="about" class="about">
    <div class="container">
        ...
        <div class="row">
            <div
                class="col-xl-5 col-lg-6 d-flex justify-content-center video-box align-items-stretch position-relative" style="border-radius: 10px;">
...
<!-- ======= Services Section ======= -->
<section id="visi_misi" class="services section-bg">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8" data-wow-delay="0.1s">
                <div class="icon-box">
            ...
            <div class="col-lg-6 col-md-8" data-wow-delay="0.2s">
                <div class="icon-box">
...
<!-- ======= Gallery Section ======= -->
<section id="paket_bimbel" class="gallery">
    <div class="container">
    ...
    <div class="container">
        ...
        <div>
            <iframe style="border:0; width: 100%; height: 270px;"
                src="https://www.gogle.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621"
